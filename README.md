...
- Understand customer preferences by vehicle type
...
- Total Failed Rides : 57000
- Failed Rate : 38.00%
- Top failed rides reason : Driver cancellation
...
-  Ride Distribution
-  Failed rides by location
-  Cancellation Analysis
-  Interactive slicers (Vehicle Type, Booking status, Date)
...
- Other factors also contributed to ride cancellations

This indicates operational inefficiencies and highlights the need for better driver management and ride allocation strategies.
...
- Cutsomer cancellations contribute less compared to driver-related issues
- Cancellation rate impacts overall revenue
- Most failed rides are Autos 
...
-Provide incentives for drivers to accapet more rides
-Enhance communication between drivers and customers to reduce misunderstandings
